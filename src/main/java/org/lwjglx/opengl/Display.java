...
public class Display {
	...
	private static org.lwjglx.opengl.DisplayMode mode, desktopDisplayMode;
	...
	static {
		...
		mode = desktopDisplayMode = new org.lwjglx.opengl.DisplayMode(monitorWidth, monitorHeight, monitorBitPerPixel, monitorRefreshRate);
	...
	private static void createWindow() throws LWJGLException {
		...
		org.lwjglx.opengl.DisplayMode mode = Display.getDisplayMode();
...
//		Display.drawable = drawable;
		...
		display_impl = new DisplayImplementation() {
			...
			@Override
			public void switchDisplayMode(org.lwjglx.opengl.DisplayMode mode) throws LWJGLException {
			...
			@Override
			public org.lwjglx.opengl.DisplayMode init() throws LWJGLException {
				// TODO Auto-generated method stub
			...
			@Override
			public org.lwjglx.opengl.DisplayMode[] getAvailableDisplayModes() throws LWJGLException {
				// TODO Auto-generated method stub
			...
			@Override
			public void createWindow(DrawableLWJGL drawable, org.lwjglx.opengl.DisplayMode mode, Canvas parent, int x, int y)
	...
	public static void setDisplayMode(org.lwjglx.opengl.DisplayMode dm) throws LWJGLException {
		mode = dm;
	...
	public static org.lwjglx.opengl.DisplayMode[] getAvailableDisplayModes() throws LWJGLException {
		GLFWVidMode.Buffer modes = GLFW.glfwGetVideoModes(GLFW.glfwGetPrimaryMonitor());

		org.lwjglx.opengl.DisplayMode[] displayModes = new org.lwjglx.opengl.DisplayMode[modes.capacity()];
		...
		for (int i = 0; i < modes.capacity(); i++) {
			...
			displayModes[i] = new org.lwjglx.opengl.DisplayMode(w, h, b, r);
		}
	...
	public static org.lwjglx.opengl.DisplayMode getDesktopDisplayMode() {
		...
		return new org.lwjglx.opengl.DisplayMode(mode.width(), mode.height(), mode.redBits() + mode.greenBits() + mode.blueBits(),
				mode.refreshRate());
	}
