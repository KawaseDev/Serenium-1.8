...
public class StreamThread extends SimpleThread {
     ...
     */
    private List<paulscode.sound.Source> streamingSources;
    ...
    public StreamThread() {
        ...
        streamingSources = new LinkedList<paulscode.sound.Source>();
    }
    ...
    @Override
    public void run() {
        ListIterator<paulscode.sound.Source> iter;
...
/*
     ...
     */
    public void watch(paulscode.sound.Source source) {
