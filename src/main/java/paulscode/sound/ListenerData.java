...
public class ListenerData {
     ...
     */
    public paulscode.sound.Vector3D position;
    /**
     * A normalized vector indicating the direction the listener is facing
     */
    public paulscode.sound.Vector3D lookAt;
    /**
     * A normalized vector indicating the up direction
     */
    public paulscode.sound.Vector3D up;
    /**
     * Listener's velocity in world-space
     */
    public paulscode.sound.Vector3D velocity;
     ...
     */
    public ListenerData() {
        position = new paulscode.sound.Vector3D(0.0f, 0.0f, 0.0f);
        lookAt = new paulscode.sound.Vector3D(0.0f, 0.0f, -1.0f);
        up = new paulscode.sound.Vector3D(0.0f, 1.0f, 0.0f);
        velocity = new paulscode.sound.Vector3D(0.0f, 0.0f, 0.0f);
        angle = 0.0f;
    }
    ...
    public ListenerData(float pX, float pY, float pZ, float lX, float lY,
        ...
        position = new paulscode.sound.Vector3D(pX, pY, pZ);
        lookAt = new paulscode.sound.Vector3D(lX, lY, lZ);
        up = new paulscode.sound.Vector3D(uX, uY, uZ);
        velocity = new paulscode.sound.Vector3D(0.0f, 0.0f, 0.0f);
        angle = a;
    }
     ...
     * @param a Angle in radians that the listener is turned counterclockwise around the y-axis.
     */
    public ListenerData(paulscode.sound.Vector3D p, paulscode.sound.Vector3D l, paulscode.sound.Vector3D u, float a) {
        position = p.clone();
        lookAt = l.clone();
        up = u.clone();
        velocity = new paulscode.sound.Vector3D(0.0f, 0.0f, 0.0f);
     ...
     * @param a Angle in radians that the listener is turned counterclockwise around the y-axis.
     */
    public void setData(paulscode.sound.Vector3D p, paulscode.sound.Vector3D l, paulscode.sound.Vector3D u, float a) {
        position.x = p.x;
        position.y = p.y;
        position.z = p.z;
        lookAt.x = l.x;
     ...
     */
    public void setPosition(paulscode.sound.Vector3D p) {
        position.x = p.x;
        position.y = p.y;
        position.z = p.z;
    }
     ...
     */
    public void setOrientation(paulscode.sound.Vector3D l, paulscode.sound.Vector3D u) {
        lookAt.x = l.x;
        lookAt.y = l.y;
        lookAt.z = l.z;
        up.x = u.x;
