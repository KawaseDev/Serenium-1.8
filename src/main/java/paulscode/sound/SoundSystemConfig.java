 ...
 */
    private static paulscode.sound.SoundSystemLogger logger = null;
 ...
 */
    private static LinkedList<paulscode.sound.IStreamListener> streamListeners = null;
/**
...
*/
                                                     ...
                                                     throws paulscode.sound.SoundSystemException
    {
        if( libraryClass == null )
            throw new paulscode.sound.SoundSystemException(
                                        "Parameter null in method 'addLibrary'",
                                        paulscode.sound.SoundSystemException.NULL_PARAMETER );
        if( !paulscode.sound.Library.class.isAssignableFrom( libraryClass ) )
            throw new paulscode.sound.SoundSystemException( "The specified class does not " +
 ...
 */
    public static void setLogger( paulscode.sound.SoundSystemLogger l )
    {
        logger = l;
    }
/**
 ...
 */
    ...
    {
        if( extension == null )
            throw new paulscode.sound.SoundSystemException( "Parameter 'extension' null in " +
                                          "method 'setCodec'.",
                                          paulscode.sound.SoundSystemException.NULL_PARAMETER );
        if( iCodecClass == null )
            throw new paulscode.sound.SoundSystemException( "Parameter 'iCodecClass' null in " +
                                          "method 'setCodec'.",
                                          paulscode.sound.SoundSystemException.NULL_PARAMETER );
        if( !paulscode.sound.ICodec.class.isAssignableFrom( iCodecClass ) )
            throw new paulscode.sound.SoundSystemException( "The specified class does " +
 ...
 */
    public static synchronized paulscode.sound.ICodec getCodec(String filename )
    {
        if( codecs == null )
            return null;
...
*/
    public static void addStreamListener( paulscode.sound.IStreamListener streamListener )
    {
        synchronized( streamListenersLock )
        {
            if( streamListeners == null )
                streamListeners = new LinkedList<paulscode.sound.IStreamListener>();
 ...
 * @param streamListener Implementation of interface 'IStreamListener'.
*/
    public static void removeStreamListener( paulscode.sound.IStreamListener streamListener )
    {
        ...
        new Thread()
        {
            ...
            public void run()
            {
                synchronized( streamListenersLock )
                {
                    if( streamListeners == null )
                        return;
                    ListIterator<paulscode.sound.IStreamListener> i = streamListeners.listIterator();
 ...
 */
        ...
        public paulscode.sound.ICodec getInstance()
        {
            if( iCodecClass == null )
                return null;
