...
public class GuiAnimationSettingsOF extends GuiScreen
{
    ...
    public void initGui()
    {
        this.title = I18n.format("animationsTitle", new Object[0]);
        ...
        this.buttonList.add(new GuiButton(210, this.width / 2 - 155, this.height / 6 + 168 + 11, 70, 20, Lang.get("animation.allOn")));
        this.buttonList.add(new GuiButton(211, this.width / 2 - 155 + 80, this.height / 6 + 168 + 11, 70, 20, Lang.get("animation.allOff")));
