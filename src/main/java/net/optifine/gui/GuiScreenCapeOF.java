...
public class GuiScreenCapeOF extends GuiScreenOF
{
    ...
    {
        int i = 0;
        this.title = I18n.format("capeOF.title", new Object[0]);
        i = i + 2;
        this.buttonList.add(new GuiButtonOF(210, this.width / 2 - 155, this.height / 6 + 24 * (i >> 1), 150, 20, I18n.format("capeOF.openEditor", new Object[0])));
        this.buttonList.add(new GuiButtonOF(220, this.width / 2 - 155 + 160, this.height / 6 + 24 * (i >> 1), 150, 20, I18n.format("capeOF.reloadCape", new Object[0])));
        i = i + 6;
        this.buttonCopyLink = new GuiButtonOF(230, this.width / 2 - 100, this.height / 6 + 24 * (i >> 1), 200, 20, I18n.format("capeOF.copyEditorLink", new Object[0]));
