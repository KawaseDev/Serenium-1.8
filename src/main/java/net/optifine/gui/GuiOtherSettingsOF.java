...
public class GuiOtherSettingsOF extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        this.title = I18n.format("otherTitle", new Object[0]);
        ...
        this.buttonList.add(new GuiButton(210, this.width / 2 - 100, this.height / 6 + 168 + 11 - 44, I18n.format("other.reset", new Object[0])));
