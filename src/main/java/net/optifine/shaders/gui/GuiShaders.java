...
public class GuiShaders extends GuiScreenOF
{
    ...
    public void initGui()
    {
        this.screenTitle = I18n.format("shadersTitle", new Object[0]);
        ...
        this.buttonList.add(new GuiButton(201, l1, i2, k1 - 22 + 1, j, Lang.get("shadersFolder")));
        ...
        this.buttonList.add(new GuiButton(203, k, this.height - 25, i, j, Lang.get("shaderOptions")));
        this.updateButtons();
    }
