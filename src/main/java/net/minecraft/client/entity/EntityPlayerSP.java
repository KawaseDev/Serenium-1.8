...
import io.github.nyghtfull.event.events.impl.game.MotionEvent;
import io.github.nyghtfull.event.events.impl.game.UpdateEvent;
import io.github.nyghtfull.event.types.EventType;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            Serenium.getInstance().getEventManager().call(new UpdateEvent());
            ...
            if (this.isRiding()) {
                ...
                Serenium.getInstance().getEventManager().call(event);
