...
import io.github.nyghtfull.event.events.impl.render.Render2DEvent;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Serenium.getInstance().getEventManager().call(new Render2DEvent(scaledresolution, partialTicks));
