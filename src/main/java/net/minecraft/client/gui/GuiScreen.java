...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected List<GuiSelectedText> selectedTextList = Lists.<GuiSelectedText>newArrayList();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (int i = 0; i < this.selectedTextList.size(); ++i)
        {
            ((GuiSelectedText)this.selectedTextList.get(i)).drawButton(this.mc, mouseX, mouseY);
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        if (mouseButton == 0)
        {
            for (int i = 0; i < this.selectedTextList.size(); ++i)
            {
                GuiSelectedText guiSelectedText = (GuiSelectedText) this.selectedTextList.get(i);

                if (guiSelectedText.mousePressed(this.mc, mouseX, mouseY))
                {
                    this.guiSelectedText = guiSelectedText;
                    guiSelectedText.playPressSound(this.mc.getSoundHandler());
                    this.actionPerformed(guiSelectedText);
                }
            }
        }
    }
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state)
    {
        ...
        if (this.guiSelectedText != null && state == 0)
        {
            this.guiSelectedText.mouseReleased(mouseX, mouseY);
            this.guiSelectedText = null;
        }
    }
    ...
    protected void actionPerformed(GuiSelectedText selectedText) throws IOException
    {
    }
    ...
    public void drawBackground(int tint)
    {
        ...
        */
        ...
        if(shader != null) {
            ...
            shader.useShader(this.width * 3, this.height * 3, Mouse.getX(), Mouse.getY(), (System.currentTimeMillis() - millis) / 1000f);
