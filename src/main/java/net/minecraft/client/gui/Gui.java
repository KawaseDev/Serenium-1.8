...
import io.github.nyghtfull.ui.GLSLSandBox;
...
public class Gui
{
    public static GLSLSandBox shader;

    static {
        try {
            shader = new GLSLSandBox(new ResourceLocation("sereniumclient/shaders/shader.fsh"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
