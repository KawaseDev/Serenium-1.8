    ...
    public SoundList deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException
    {
        ...
        if (jsonobject.has("sounds"))
        {
            ...
            for (int i = 0; i < jsonarray.size(); ++i)
            {
                ...
                {
                    soundlist$soundentry.setSoundEntryName(JsonUtils.getString(jsonelement, "paulscode/sound"));
                }
                else
                {
                    JsonObject jsonobject1 = JsonUtils.getJsonObject(jsonelement, "paulscode/sound");
