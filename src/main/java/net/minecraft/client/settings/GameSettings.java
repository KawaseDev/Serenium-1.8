...
public class GameSettings
{
    ...
    private String getKeyBindingOF(GameSettings.Options p_getKeyBindingOF_1_)
    {
        ...
        if (p_getKeyBindingOF_1_ == GameSettings.Options.RENDER_DISTANCE)
        {
            ...
            if (i1 >= 32)
            {
                s1 = Lang.get("renderDistance.extreme");
                i = 32;
            }

            if (i1 >= 48)
            {
                s1 = Lang.get("renderDistance.insane");
                i = 48;
            }

            if (i1 >= 64)
            {
                s1 = Lang.get("renderDistance.ludicrous");
                i = 64;
            }
        ...
        else if (p_getKeyBindingOF_1_ == GameSettings.Options.MIPMAP_TYPE)
        {
            ...
            {
                case 0:
                    return s + Lang.get("mipmap.nearest");

                case 1:
                    return s + Lang.get("mipmap.linear");

                case 2:
                    return s + Lang.get("mipmap.bilinear");

                case 3:
                    return s + Lang.get("mipmap.trilinear");

                default:
                    return s + "mipmap.nearest";
            }
        }
        ...
        else if (p_getKeyBindingOF_1_ == GameSettings.Options.ANIMATED_WATER)
        {
            ...
            {
                case 1:
                    return s + Lang.get("animation.dynamic");
        ...
        {
            int l = 900;
            return this.ofAutoSaveTicks <= l ? s + Lang.get("save.45s") : (this.ofAutoSaveTicks <= 2 * l ? s + Lang.get("save.90s") : (this.ofAutoSaveTicks <= 4 * l ? s + Lang.get("save.3min") : (this.ofAutoSaveTicks <= 8 * l ? s + Lang.get("save.6min") : (this.ofAutoSaveTicks <= 16 * l ? s + Lang.get("save.12min") : s + Lang.get("save.24min")))));
        }
        ...
        {
            return this.ofTime == 1 ? s + Lang.get("time.dayOnly") : (this.ofTime == 2 ? s + Lang.get("time.nightOnly") : s + Lang.getDefault());
        }
        ...
        else if (p_getKeyBindingOF_1_ == GameSettings.Options.FRAMERATE_LIMIT)
        {
            ...
            return f == 0.0F ? s + Lang.get("framerateLimit.vsync") : (f == p_getKeyBindingOF_1_.valueMax ? s + I18n.format("options.framerateLimit.max", new Object[0]) : s + (int)f + " fps");
        }
        else
        {
            return null;
    ...
    public static enum Options
    {
        ...
        FOG_FANCY("FOG_FANCY", false, false),
        FOG_START("FOG_START", false, false),
        MIPMAP_TYPE("MIPMAP_TYPE", true, false, 0.0F, 3.0F, 1.0F),
        SMOOTH_FPS("SMOOTH_FPS", false, false),
        CLOUDS("CLOUDS", false, false),
        CLOUD_HEIGHT("CLOUD_HEIGHT", true, false),
        TREES("TREES", false, false),
        RAIN("RAIN", false, false),
        ANIMATED_WATER("ANIMATED_WATER", false, false),
        ANIMATED_LAVA("ANIMATED_LAVA", false, false),
        ANIMATED_FIRE("ANIMATED_FIRE", false, false),
        ANIMATED_PORTAL("ANIMATED_PORTAL", false, false),
        AO_LEVEL("AO_LEVEL", true, false),
        LAGOMETER("LAGOMETER", false, false),
        SHOW_FPS("SHOW_FPS", false, false),
        AUTOSAVE_TICKS("AUTOSAVE_TICKS", false, false),
        BETTER_GRASS("BETTER_GRASS", false, false),
        ANIMATED_REDSTONE("ANIMATED_REDSTONE", false, false),
        ANIMATED_EXPLOSION("ANIMATED_EXPLOSION", false, false),
        ANIMATED_FLAME("ANIMATED_FLAME", false, false),
        ANIMATED_SMOKE("ANIMATED_SMOKE", false, false),
        WEATHER("WEATHER", false, false),
        SKY("SKY", false, false),
        STARS("STARS", false, false),
        SUN_MOON("SUN_MOON", false, false),
        VIGNETTE("VIGNETTE", false, false),
        CHUNK_UPDATES("CHUNK_UPDATES", false, false),
        CHUNK_UPDATES_DYNAMIC("CHUNK_UPDATES_DYNAMIC", false, false),
        TIME("TIME", false, false),
        CLEAR_WATER("CLEAR_WATER", false, false),
        SMOOTH_WORLD("SMOOTH_WORLD", false, false),
        VOID_PARTICLES("VOID_PARTICLES", false, false),
        WATER_PARTICLES("WATER_PARTICLES", false, false),
        RAIN_SPLASH("RAIN_SPLASH", false, false),
        PORTAL_PARTICLES("PORTAL_PARTICLES", false, false),
        POTION_PARTICLES("POTION_PARTICLES", false, false),
        FIREWORK_PARTICLES("FIREWORK_PARTICLES", false, false),
        PROFILER("PROFILER", false, false),
        DRIPPING_WATER_LAVA("DRIPPING_WATER_LAVA", false, false),
        BETTER_SNOW("BETTER_SNOW", false, false),
        FULLSCREEN_MODE("FULLSCREEN_MODE", true, false, 0.0F, (float)Config.getDisplayModes().length, 1.0F),
        ANIMATED_TERRAIN("ANIMATED_TERRAIN", false, false),
        SWAMP_COLORS("SWAMP_COLORS", false, false),
        RANDOM_ENTITIES("RANDOM_ENTITIES", false, false),
        SMOOTH_BIOMES("SMOOTH_BIOMES", false, false),
        CUSTOM_FONTS("CUSTOM_FONTS", false, false),
        CUSTOM_COLORS("CUSTOM_COLORS", false, false),
        SHOW_CAPES("SHOW_CAPES", false, false),
        CONNECTED_TEXTURES("CONNECTED_TEXTURES", false, false),
        CUSTOM_ITEMS("CUSTOM_ITEMS", false, false),
        AA_LEVEL("AA_LEVEL", true, false, 0.0F, 16.0F, 1.0F),
        AF_LEVEL("AF_LEVEL", true, false, 1.0F, 16.0F, 1.0F),
        ANIMATED_TEXTURES("ANIMATED_TEXTURES", false, false),
        NATURAL_TEXTURES("NATURAL_TEXTURES", false, false),
        EMISSIVE_TEXTURES("EMISSIVE_TEXTURES", false, false),
        HELD_ITEM_TOOLTIPS("HELD_ITEM_TOOLTIPS", false, false),
        DROPPED_ITEMS("DROPPED_ITEMS", false, false),
        LAZY_CHUNK_LOADING("LAZY_CHUNK_LOADING", false, false),
        CUSTOM_SKY("CUSTOM_SKY", false, false),
        FAST_MATH("FAST_MATH", false, false),
        FAST_RENDER("FAST_RENDER", false, false),
        TRANSLUCENT_BLOCKS("TRANSLUCENT_BLOCKS", false, false),
        DYNAMIC_FOV("DYNAMIC_FOV", false, false),
        DYNAMIC_LIGHTS("DYNAMIC_LIGHTS", false, false),
        ALTERNATE_BLOCKS("ALTERNATE_BLOCKS", false, false),
        CUSTOM_ENTITY_MODELS("CUSTOM_ENTITY_MODELS", false, false),
        ADVANCED_TOOLTIPS("ADVANCED_TOOLTIPS", false, false),
        SCREENSHOT_SIZE("SCREENSHOT_SIZE", false, false),
        CUSTOM_GUIS("CUSTOM_GUIS", false, false),
        RENDER_REGIONS("RENDER_REGIONS", false, false),
        SHOW_GL_ERRORS("SHOW_GL_ERRORS", false, false),
        SMART_ANIMATIONS("SMART_ANIMATIONS", false, false);
