package io.github.nyghtfull.ui;
...
public class GLSLSandBox {
    private final int programId, timeUniform, mouseUniform, resolutionUniform;

    public GLSLSandBox(ResourceLocation rl) throws IOException {
        int program = glCreateProgram();

        glAttachShader(program, createShader(Minecraft.getMinecraft().mcResourceManager.getResource(new ResourceLocation("sereniumclient/shaders/passthrough.vsh")).getInputStream(), GL_VERTEX_SHADER));
