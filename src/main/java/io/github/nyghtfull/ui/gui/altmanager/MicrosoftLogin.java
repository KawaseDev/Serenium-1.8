...
public class MicrosoftLogin {
    ...
    public static void getRefreshToken(final Consumer<String> callback, boolean browser) {
    ...
    public static LoginData login(String refreshToken) {
        ...
        final AuthTokenResponse res = gson.fromJson(
                BroswerUtil.postExternal("https://login.live.com/oauth20_token.srf", "client_id=" + CLIENT_ID + "&client_secret=" + CLIENT_SECRET + "&refresh_token=" + refreshToken + "&grant_type=refresh_token&redirect_uri=http://localhost:" + PORT, false),
        ...
        final XblXstsResponse xblRes = gson.fromJson(
                BroswerUtil.postExternal("https://user.auth.xboxlive.com/user/authenticate",
        ...
        final XblXstsResponse xstsRes = gson.fromJson(
                BroswerUtil.postExternal("https://xsts.auth.xboxlive.com/xsts/authorize",
        ...
        final McResponse mcRes = gson.fromJson(
                BroswerUtil.postExternal("https://api.minecraftservices.com/authentication/login_with_xbox",
    ...
    private static class Handler implements HttpHandler {
        ...
        private void handleCode(final String code) {
            ...
            final String response = BroswerUtil.postExternal("https://login.live.com/oauth20_token.srf",
